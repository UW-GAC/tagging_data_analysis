...
While I've previously included only the studies that were funded for tagging through subcontracts, for my current analysis I'd like to take a look at all of the studies. So the evaluation of this code block is turned off.

```{r subset-studies, eval=FALSE}
